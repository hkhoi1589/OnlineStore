...
const createOrder = async (customerID, body, orderID, totalprice) => {
...
const getOrderDetails = async (req) => {
	...
	const itemInfoValues = [req.customerID];
...
/* Function to get recent orders for a particular customerID */
const getRecentOrders = async (customerID) => {
...
const orderHistoryPermissionChecker = async (req) => {
	...
	const values = [req.customerID, req.params.orderId];
